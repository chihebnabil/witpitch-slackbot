...
const CANDIDATE_PITCH_SYSTEM_PROMPT = `Write a short and concise recommendation to interview this individual for a client based on the following guidelines :
